    ...
    CKEDITOR.plugins.add("autosave", {
        ...
        init: function (editor) {
            ...
            var defaultConfig = {
                ...
                saveOnDestroy: false,
                NotOlderThen: 1440,
                SaveKey: 'autosave_' + window.location + "_" + document.getElementById(editor.name).getAttribute('name'),
                diffType: "sideBySide",
                autoLoad: false
            };
            ...
            editor.on('instanceReady', function () {
                if (typeof jQuery === 'undefined') {
                    CKEDITOR.scriptLoader.load(editor.config.jq_cdn, function () {
                        jQuery.noConflict();
    ...
    function SaveData(autoSaveKey, editorInstance, config) {
        ...
        if (quotaExceeded) {
            var notificationError = new CKEDITOR.plugins.notification(editorInstance, {
                message: editorInstance.lang.autosave.localStorageFull,
                type: 'warning'
            });
