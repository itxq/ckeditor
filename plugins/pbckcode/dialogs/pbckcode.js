                ...
                children: [
                    {
                        type: 'text',
                        id: 'code-title',
                        label: editor.lang.pbckcode.codeTitle,
                        'default': '',
                        setup: function (element) {
                            if (element) {
                                element = element.getAscendant('pre', true);
                                this.setValue(element.getAttribute('data-pbcktitle'));
                            }
                        },
                        commit: function (element) {
                            if (element) {
                                element = element.getAscendant('pre', true);
                                element.setAttribute('data-pbcktitle', this.getValue());
                            }
                        },
                        onChange: function () {
                        }
                    },
                    {
                        ...
                        label: editor.lang.pbckcode.codeMarked,
                        'default': '',
                        setup: function (element) {
                            if (element) {
                                element = element.getAscendant('pre', true);
                                this.setValue(element.getAttribute('data-pbckmarked'));
                            }
                        },
                        commit: function (element) {
                            if (element) {
                                element = element.getAscendant('pre', true);
                                element.setAttribute('data-pbckmarked', this.getValue());
                            }
                        },
                        onChange: function () {
                        }
                    },
                    {
                        type: 'select',
                        id: 'code-inline',
                        label: editor.lang.pbckcode.codeInline,
                        items: [['多行代码', 'false'], ['单行代码', 'true']],
                        'default': 'false',
                        setup: function (element) {
                            if (element) {
                                element = element.getAscendant('pre', true);
                                this.setValue(element.getAttribute('data-pbckinline'));
                            }
                        },
                        commit: function (element) {
                            if (element) {
                                element = element.getAscendant('pre', true);
                                element.setAttribute('data-pbckinline', this.getValue());
                            }
                        },
                        onChange: function () {
                        }
            ...
            },
            {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        label: editor.lang.pbckcode.codeThemes,
                        items: editor.settings.code_themes,
                        'default': editor.settings.code_themes[0][1],
                        setup: function (element) {
                            if (element) {
                                element = element.getAscendant('pre', true);
                                this.setValue(element.getAttribute('data-pbckcodetheme'));
                            }
                        },
                        commit: function (element) {
                            if (element) {
                                element = element.getAscendant('pre', true);
                                element.setAttribute('data-pbckcodetheme', this.getValue());
                            }
                        },
                        onChange: function () {
                        }
                    },
                    {
                        type: 'select',
                        id: 'code-font',
                        label: editor.lang.pbckcode.codeFonts,
                        items: editor.settings.code_fonts,
                        'default': editor.settings.code_fonts[0][1],
                        setup: function (element) {
                            if (element) {
                                element = element.getAscendant('pre', true);
                                this.setValue(element.getAttribute('data-pbckcodetfont'));
                            }
                        },
                        commit: function (element) {
                            if (element) {
                                element = element.getAscendant('pre', true);
                                element.setAttribute('data-pbckcodetfont', this.getValue());
                            }
                        },
                        onChange: function () {
                        }
